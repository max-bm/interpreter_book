...
func (l *Lexer) NextToken() token.Token {
	...
	case 0:
		// This is set in a different way so we can directly assign the Literal as an
		// empty string, instead of having to pass a byte to newToken.
...
// A helper method attached to the Lexer data structure to check the next characters
// without advancing the position or readPosition
